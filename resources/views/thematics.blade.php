...
<script type="text/javascript">
    function asideswipe()   {
        ...
        if(display == "block")  {
            ...
            document.getElementById("button_roll").style.display = "block";
            document.getElementById("button_roll2").style.display = "none";
        }else   {
            document.getElementById("aside").style.display = "block";
            document.getElementById("acontent").className = "col-md-9";
            document.getElementById("button_roll").style.display = "none";
            document.getElementById("button_roll2").style.display = "block";
        }
    }  
</script>
<div class="container_hidden">
	...
	<div class="row" style="height: 100%;">
		<div class="col-md-3" id="aside">
    		...
    		<button id="button_roll2" onClick="asideswipe()"><img src="../resources/images/picto_roll.svg" class="picto"></button>
		...
		<button id="button_roll" onClick="asideswipe()"><img src="../resources/images/picto_roll.svg" class="picto"></button>
		      ...
		      <a href="{{ route('chat') }}">
                        <div class="thematique_lien">
                            ...
                            <div class="thematique_titre">
                                ...
                                <span class="thematique_author">{{$user->identity}}</span> - <span class="thematique_date">Posté le {{$posts->date_creation}}</span>
                                        </td>
